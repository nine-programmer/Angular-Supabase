...
| Deploy         | Node web service (Render / host Node อื่น / เซิร์ฟเวอร์ตัวเอง)  | ระบุใน SYSTEM_SPEC                                                  |
...
ที่วางไฟล์ของความต้องการระดับ "พอดี แต่ต้องตัดสินใจ" (login, อัปโหลด, แจ้งเตือน, งานตามเวลา, รายงาน ฯลฯ) อยู่ใน **`docs/EXTENSION_POINTS.md`** — โฟลเดอร์ในนั้นถือว่าอยู่ในผังข้อ 3 แล้ว อ่านเฉพาะเมื่อ SPEC ต้องการความสามารถนั้น
