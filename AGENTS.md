...
- Before reporting a task as done (and before every commit), run `npm run format` then `npm test`. Prettier owns code style: do not hand-align or restyle code, and do not add style rules to this file.
