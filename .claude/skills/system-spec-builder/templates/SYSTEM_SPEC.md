...
**ลำดับการทำงาน**
1. อ่านให้ครบก่อน: `AGENTS.md` (กติกาโค้ด) → `docs/ARCHITECTURE.md` (โครงสร้าง) → เอกสารนี้ → `docs/DESIGN.md` (ระบบออกแบบ — มีหลัง Task Design UX/UI ผ่าน; ถ้ามีแล้ว ทุก Task ที่มีหน้าจอต้องทำตาม) → `docs/TASKS.md` (ความคืบหน้า) → บันทึกล่าสุดใน `.sessions/` (ถ้ามี — สิ่งที่ AI คนก่อนทำและตัดสินใจไว้)
